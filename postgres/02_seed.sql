...
(8, 'BTC-USDT', 1, 'unsubscribe'), -- okx BTC/USDT
(8, 'ETH-USDT', 3, 'unsubscribe'), -- okx ETH/USDT
(8, 'XRP-USDT', 5, 'unsubscribe'), -- okx XRP/USDT
(8, 'TRX-USDT', 7, 'unsubscribe'), -- okx TRX/USDT
(8, 'SOL-USDT', 9, 'unsubscribe'), -- okx SOL/USDT
(8, 'DOT-USDT', 11, 'unsubscribe'), -- okx DOT/USDT
(8, 'HYPE-USDT', 13, 'unsubscribe'), -- okx HYPE/USDT
(8, 'DOGE-USDT', 15, 'unsubscribe'), -- okx DOGE/USDT
(8, 'PEPE-USDT', 17, 'unsubscribe'), -- okx PEPE/USDT
(8, 'SUI-USDT', 19, 'unsubscribe'), -- okx SUI/USDT
(8, 'ZEC-USDT', 21, 'unsubscribe'), -- okx ZEC/USDT
(8, 'XLM-USDT', 23, 'unsubscribe'), -- okx XLM/USDT
(8, 'LINK-USDT', 25, 'unsubscribe'), -- okx LINK/USDT
(8, 'AVAX-USDT', 27, 'unsubscribe'), -- okx AVAX/USDT
(8, 'PAXG-USDT', 29, 'unsubscribe'), -- okx PAXG/USDT
(8, 'XAUT-USDT', 31, 'unsubscribe'), -- okx XAUT/USDT
(8, 'NEAR-USDT', 33, 'unsubscribe'), -- okx NEAR/USDT
(8, 'UNI-USDT', 35, 'unsubscribe'), -- okx UNI/USDT
(8, 'AAVE-USDT', 37, 'unsubscribe'), -- okx AAVE/USDT
(8, 'OKX-USDT', 39, 'unsubscribe'), -- okx OKX/USDT
(8, 'ADA-USDT', 41, 'unsubscribe'), -- okx ADA/USDT
(8, 'GRAM-USDT', 43, 'unsubscribe'), -- okx GRAM/USDT
(8, 'BNB-USDT', 45, 'unsubscribe'), -- okx BNB/USDT
(8, 'WLD-USDT', 47, 'unsubscribe'), -- okx WLD/USDT
(8, 'MNT-USDT', 49, 'unsubscribe'), -- okx MNT/USDT
(8, 'SHIB-USDT', 51, 'unsubscribe'), -- okx SHIB/USDT
(8, 'BTT-USDT', 53, 'unsubscribe'); -- okx BTT/USDT
