...
- [x] **`scripts/watch-topic.sh <topic>`** (2026-09-14, user request): live tail of partition/offset/CreateTime for one topic, instead of Kafka UI live mode. `bash -n` and the usage path were checked; NOT run against a broker yet. See [[project_kafka_topic_strategy]] § 2026-09-14
