...
/**
 * Loads Avro {@link Schema}s. {@link #loadLatest} is what the production (de)serializers use — it
 ...
 *
 * <p>Deliberately duplicated from normalizer-common rather than depended upon: see the rationale
