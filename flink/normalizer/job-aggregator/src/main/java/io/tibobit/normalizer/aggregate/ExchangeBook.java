 ...
 * produces two of these (asks, bids) from each job-6 {@code OrderBookSnapshot}, and
 ...
 * event_time. An empty {@code levels} list (job 6's reset ⇒ empty book) replaces the stored entry
